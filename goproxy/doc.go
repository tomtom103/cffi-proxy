...
The proxy itself is simply an `http "github.com/bogdanfinn/fhttp"` handler.
...
1. https://github.com/tomtom103/proxy-cffi/goproxy/tree/master/examples/goproxy-avgsize
...
3. https://github.com/tomtom103/proxy-cffi/goproxy/blob/master/examples/goproxy-httpdump/
...
4. https://github.com/tomtom103/proxy-cffi/goproxy/tree/master/examples/goproxy-no-reddit-at-worktime

Will allow browsing to reddit.com between 8:00am and 17:00pm

5. https://github.com/tomtom103/proxy-cffi/goproxy/tree/master/examples/goproxy-jquery-version

Will warn if multiple versions of jquery are used in the same domain.

6. https://github.com/tomtom103/proxy-cffi/goproxy/blob/master/examples/goproxy-upside-down-ternet/
