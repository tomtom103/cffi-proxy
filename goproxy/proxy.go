...
func removeProxyHeaders(ctx *ProxyCtx, r *http.Request) {
	...
	// https://github.com/golang/go/blob/master/src/http "github.com/bogdanfinn/fhttp"/request.go#L1080
	// Later, transfer.go adds "Connection: close" back when req.Close is true
	// https://github.com/golang/go/blob/master/src/http "github.com/bogdanfinn/fhttp"/transfer.go#L275
...
// Standard http "github.com/bogdanfinn/fhttp" function. Shouldn't be used directly, http.Serve will use it.
